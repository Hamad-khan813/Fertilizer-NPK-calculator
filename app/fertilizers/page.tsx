    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-br from-green-50 to-green-100 py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-2">Fertilizer Database</h1>
          <p className="text-lg text-gray-600">Browse all 52+ fertilizers with complete NPK specifications</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {filtered.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-lg text-gray-600">No fertilizers found matching "{searchQuery}"</p>
          </div>
        ) : (
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-gray-200 bg-gray-50">
                        ...
                        <th className="px-6 py-3 text-center text-sm font-semibold text-gray-900">Code</th>
                        <th className="px-6 py-3 text-center text-sm font-semibold text-gray-900">N %</th>
                        <th className="px-6 py-3 text-center text-sm font-semibold text-gray-900">P₂O₅ %</th>
                        <th className="px-6 py-3 text-center text-sm font-semibold text-gray-900">K₂O %</th>
                        <th className="px-6 py-3 text-center text-sm font-semibold text-gray-900">Form</th>
                    ...
                    <tbody>
                      {fertsInCategory.map((fert, idx) => (
                        <tr key={fert.id} className={idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                          ...
                          <td className="px-6 py-4 text-center text-sm text-gray-600">{fert.N}</td>
                          <td className="px-6 py-4 text-center text-sm text-gray-600">{fert.P}</td>
                          <td className="px-6 py-4 text-center text-sm text-gray-600">{fert.K}</td>
        ...
        <div className="text-center text-sm text-gray-600 mt-12 pt-8 border-t border-gray-200">
