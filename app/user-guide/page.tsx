    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-br from-green-50 to-green-100 py-12 sm:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">How to Use the NPK Calculator</h1>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-12">
        ...
        <section>
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Step-by-Step Guide</h2>
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Enter Your Target N%</h3>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Enter Target P% (as P₂O₅)</h3>
                  <p className="text-gray-700">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Enter Target K% (as K₂O)</h3>
                  <p className="text-gray-700">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Set Your Volume</h3>
                  <p className="text-gray-700">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Select Fertilizer and Calculate</h3>
                  <p className="text-gray-700">
        ...
        <section>
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Understanding Your Results</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-3">Amount to Use</h3>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-3">Actual NPK Delivered</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-3">Warning Messages</h3>
              <p className="text-gray-700 text-sm">
        ...
        <section>
          <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">💡 Practical Tips</h2>
        ...
        <section>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-2">What does P₂O₅ mean?</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-2">My result shows a warning — what do I do?</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-2">Can I use this for drip irrigation?</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-2">Is this calculator free?</h3>
              <p className="text-gray-700">
