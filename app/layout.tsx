  ...
  return (
    ...
    >
      <head>
        <script
          async
          src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5989420754611721"
        ...
        <Script id="google-tag-manager" strategy="beforeInteractive">
          {`
            ...
            })(window,document,'script','dataLayer','GTM-TJK3D923');
          `}
        </Script>
      ...
      <body className="min-h-full flex flex-col">
        ...
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TJK3D923"
