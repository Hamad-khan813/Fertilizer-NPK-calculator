    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-gradient-to-br from-primary/5 to-primary-20/40 py-12 sm:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-4">What Is NPK?</h1>
          <p className="text-lg text-slate-600">A complete guide to understanding plant nutrition</p>
        </div>
      </div>
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">Understanding NPK: The Foundation of Plant Nutrition</h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-6">What Does NPK Stand For?</h2>
        ...
        {/* Reading the Label */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-6">How to Read a Fertilizer Label</h2>
          <p className="text-slate-700 leading-relaxed mb-6">
            Consider a bag labeled <strong>18-46-0</strong>:
          </p>

          <ul className="space-y-3 text-slate-700 mb-6 ml-4">
        ...
        {/* Crop Requirements */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-6">NPK Requirements by Crop</h2>
          <p className="text-slate-700 leading-relaxed mb-6">
            ...
            <table className="w-full bg-white rounded-lg border border-slate-200">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200">
                  <th className="px-6 py-3 text-left text-sm font-semibold text-slate-900">Crop</th>
                  <th className="px-6 py-3 text-center text-sm font-semibold text-slate-900">Growth Stage</th>
                  <th className="px-6 py-3 text-center text-sm font-semibold text-slate-900">Recommended NPK</th>
                  <th className="px-6 py-3 text-left text-sm font-semibold text-slate-900">Notes</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-slate-200 hover:bg-slate-50">
                  <td className="px-6 py-3 text-sm font-medium text-slate-900">Wheat</td>
                  <td className="px-6 py-3 text-center text-sm text-slate-700">Tillering to Grain Fill</td>
                  <td className="px-6 py-3 text-center text-sm text-slate-700">15-10-15</td>
                  <td className="px-6 py-3 text-sm text-slate-700">Avoid excess N to prevent lodging</td>
                </tr>
                <tr className="border-b border-slate-200 hover:bg-slate-50">
                  <td className="px-6 py-3 text-sm font-medium text-slate-900">Tomatoes</td>
                  <td className="px-6 py-3 text-center text-sm text-slate-700">Flowering & Fruiting</td>
                  <td className="px-6 py-3 text-center text-sm text-slate-700">10-20-20</td>
                  <td className="px-6 py-3 text-sm text-slate-700">Reduce N to encourage fruiting</td>
                </tr>
                <tr className="border-b border-slate-200 hover:bg-slate-50">
                  <td className="px-6 py-3 text-sm font-medium text-slate-900">Lettuce</td>
                  <td className="px-6 py-3 text-center text-sm text-slate-700">Vegetative</td>
                  <td className="px-6 py-3 text-center text-sm text-slate-700">20-10-10</td>
                  <td className="px-6 py-3 text-sm text-slate-700">High N for lush foliage</td>
                </tr>
                <tr className="border-b border-slate-200 hover:bg-slate-50">
                  <td className="px-6 py-3 text-sm font-medium text-slate-900">Potatoes</td>
                  <td className="px-6 py-3 text-center text-sm text-slate-700">Tuber Development</td>
                  <td className="px-6 py-3 text-center text-sm text-slate-700">10-10-20</td>
                  <td className="px-6 py-3 text-sm text-slate-700">Higher K for yield and disease resistance</td>
                </tr>
                <tr className="hover:bg-slate-50">
                  <td className="px-6 py-3 text-sm font-medium text-slate-900">Turf Grass</td>
                  <td className="px-6 py-3 text-center text-sm text-slate-700">Maintenance</td>
                  <td className="px-6 py-3 text-center text-sm text-slate-700">15-5-10</td>
                  <td className="px-6 py-3 text-sm text-slate-700">Balanced with emphasis on N and K</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        {/* Deficiency Symptoms */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-6">How to Recognize Nutrient Deficiencies</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-primary-20/10 border-l-4 border-primary p-6 rounded">
              <h3 className="text-lg font-bold text-primary-dark mb-2">Phosphorus Deficiency</h3>
              <p className="text-slate-700">
        ...
        {/* Best Practices */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-6">Best Practices for Using NPK Fertilizers</h2>
        ...
        {/* Conclusion */}
        <section>
          <h2 className="text-2xl font-bold text-slate-900 mb-6">The Bottom Line</h2>
          ...
          <ul className="space-y-2 text-slate-700 mb-6 ml-4">
